...
FIND_PATH (RBDL_INCLUDE_DIR rbdl/rbdl.h
	...
	/usr/local/include
	/usr/include
	/home/martindzida/faks/PROJEKT/libs/rbdl/include
	)
...
FIND_LIBRARY (RBDL_LIBRARY NAMES rbdl
	...
	/home/martindzida/faks/PROJEKT/libs/rbdl/build
	)
...
ELSE (RBDL_INCLUDE_DIR AND RBDL_LIBRARY)
	MESSAGE(ERROR " ABRAKADABRA")
	MESSAGE(ERROR " ${RBDL_INCLUDE_DIR}")
	MESSAGE(ERROR " ${RBDL_LIBRARY}")
